...
public final class ColorKt {
    ...
    private static final long status_pending = 0L;
    private static final long status_completed = 0L;
    private static final long status_error = 0L;
    private static final long status_info = 0L;
    private static final long background_primary = 0L;
    private static final long background_secondary = 0L;
    private static final long background_tertiary = 0L;
    ...
    public static final long getSpaceCadet() {
        return 0L;
    }
    
    public static final long getAmericanBlue() {
        return 0L;
    }
    
    public static final long getQueenBlue() {
        return 0L;
    }
    ...
    public static final long getStatus_pending() {
        return 0L;
    }
    
    public static final long getStatus_completed() {
        return 0L;
    }
    
    public static final long getStatus_error() {
        return 0L;
    }
    
    public static final long getStatus_info() {
        return 0L;
    }
    
    public static final long getBackground_primary() {
        return 0L;
    }
    
    public static final long getBackground_secondary() {
        return 0L;
    }
    
    public static final long getBackground_tertiary() {
        return 0L;
    }
